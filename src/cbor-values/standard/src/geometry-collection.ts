import { GeometryCollectionBase as Base } from "@tai-kun/surreal/cbor-values/encodable";
import { type Coord, isGeometryCollection } from "~/cbor-values/geometry";
...
export type { GeoJsonCollection } from "@tai-kun/surreal/cbor-values/encodable";
