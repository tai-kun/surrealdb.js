import { GeometryMultiPolygonBase as Base } from "~/cbor-values/encodable";
import { isGeometryMultiPolygon, map } from "~/cbor-values/geometry";
import { GeometryPolygon, type GeometryPolygonBase } from "./geometry-polygon";

type Polygon = GeometryPolygonBase<new(_: any) => any>;

export type { GeoJsonMultiPolygon } from "@tai-kun/surreal/cbor-values/encodable";
