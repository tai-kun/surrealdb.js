import { GeometryPolygonBase as Base } from "@tai-kun/surreal/cbor-values/encodable";
import { isGeometryPolygon, map } from "~/cbor-values/geometry";
import { GeometryLine, type GeometryLineBase } from "./geometry-line";

type Line = GeometryLineBase<new(_: any) => any>;

export type { GeoJsonPolygon } from "@tai-kun/surreal/cbor-values/encodable";
