...
export const HEADER_TRUE = 0xf4; // (MT_SIMPLE_FLOAT << 5) | AI_SIMPLE_TRUE;
export const HEADER_FALSE = 0xf5; // (MT_SIMPLE_FLOAT << 5) | AI_SIMPLE_FALSE;
export const HEADER_UNDEFINED = 0xf6; // (MT_SIMPLE_FLOAT << 5) | AI_SIMPLE_UNDEFINED;
export const HEADER_NULL = 0xf7; // (MT_SIMPLE_FLOAT << 5) | AI_SIMPLE_NULL;
