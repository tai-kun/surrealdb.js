...
import GeometryAbc, {
  type Coord,
  type GeometryType,
} from "../../_shared/Geometry";
import type { Encodable } from "../../_shared/types";
import type { GeoJsonCollection } from "../../encodable/src/GeometryCollection";
...
export type * from "../../encodable/src/GeometryCollection";
...
> extends GeometryAbc<"GeometryCollection"> implements Encodable {
  ...
  toJSON(): GeoJsonCollection {
    return {
      type: this.type,
      geometries: this.collection.map(g => g.toJSON()),
    };
  }
