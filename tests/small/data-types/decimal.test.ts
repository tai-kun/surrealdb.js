...
describe("decode-only/encodable", () => {
  describe("有効な文字列", () => {
    ...
    test(".toPlainObject()", () => {
      const toPlainObject = new EncodableDecimal("1.23e1").toPlainObject();
...
describe("standard", () => {
  describe("有効な文字列", () => {
    ...
    test(".toPlainObject()", () => {
      const toPlainObject = new Decimal("1.23e1").toPlainObject();
  ...
  describe("有効な数値", () => {
    ...
    test(".toPlainObject()", () => {
      const toPlainObject = new Decimal(3.14).toPlainObject();
